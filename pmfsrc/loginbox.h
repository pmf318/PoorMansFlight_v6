...
#define LGNBOX_HELP "Hint: Click 'New/Edit'"
...
{
    Q_OBJECT
    GString dbType, dbName, userName, passWord, hostName, port, options;
...
protected slots:
    ...
    virtual void togglePwdClicked();
    virtual void toggleSysDbs();
    void closeEvent( QCloseEvent*);
    void keyPressEvent(QKeyEvent *event);
    void getConnDataSlot(int pos);
    void getAllDatabases(int pos);
    void getAllHosts();
    void setUidAndPwd(int pos);


protected:
    QComboBox* dbNameCB;
    QComboBox* dbTypeCB;
    QComboBox* userNameCB;
    QLineEdit* passWordLE;
    QComboBox* hostNameCB;
    QCheckBox* setDefaultConnChkBx;
    QCheckBox* hideSysDbsChkBx;
    //QLineEdit* portLE;
    QPushButton* okB;
    QPushButton* cancelB;
    QPushButton* helpB;
    QPushButton* viewPwdB;

private:
    int bindAndConnect(DSQLPlugin *pDSQL, GString db, GString uid, GString pwd, GString node, GString port, GString options = "", GString pwdCmd = "");
    ...
    void findDatabases();
    void addDbNameToComboBox(GString dbName);
